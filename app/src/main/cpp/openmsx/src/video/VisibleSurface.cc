...
#elif OPENGL_VERSION == OPENGL_ES_3_0
	#define VERSION_STRING "OpenGL ES 3.0"
...
//    SDL_GL_SetAttribute(SDL_GL_CONTEXT_MINOR_VERSION, 0);
	...
	//   circumvent this situation, the glewExperimental global switch OSCcan
...
#if defined(__ANDROID__)
    int android_window_max_w, android_window_max_h;
    SDL_GetWindowSize(window.get(), &android_window_max_w, &android_window_max_h);
#endif
