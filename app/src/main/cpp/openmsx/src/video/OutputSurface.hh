...
public:
    ...
    [[nodiscard]] int getGuiTopReservedPixels() const { return m_guiTopReservedPixels; }
    void setGuiTopReservedPixels(int px) { m_guiTopReservedPixels = px < 0 ? 0 : px; }
#endif
