...
ImGuiManager::ImGuiManager(Reactor& reactor_)
	...
	, fontPropFilename(reactor.getCommandController(), "gui_font_default_filename", "TTF font filename for the default GUI font", "DejaVuSans.ttf")
	, fontMonoFilename(reactor.getCommandController(), "gui_font_mono_filename", "TTF font filename for the monospaced GUI font", "DejaVuSansMono.ttf")
    ...
    , fontPropSize(reactor.getCommandController(), "gui_font_default_size", "size for the default GUI font", 21, 9, 72)
    , fontMonoSize(reactor.getCommandController(), "gui_font_mono_size", "size for the monospaced GUI font", 21, 9, 72)
#else
